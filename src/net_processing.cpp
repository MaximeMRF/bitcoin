...
static constexpr auto AVG_LOCAL_ADDRESS_BROADCAST_INTERVAL{4h};
 ...
 *  Blocks and peers with NetPermissionFlags::NoBan permission bypass this. */
static constexpr auto OUTBOUND_INVENTORY_BROADCAST_INTERVAL{500ms};
/** Maximum rate of inventory items to send per second.
 *  Limits the impact of low-fee transaction floods. */
static constexpr unsigned int INVENTORY_BROADCAST_PER_SECOND{100};
...
static constexpr unsigned int INVENTORY_BROADCAST_MAX = 2000;
